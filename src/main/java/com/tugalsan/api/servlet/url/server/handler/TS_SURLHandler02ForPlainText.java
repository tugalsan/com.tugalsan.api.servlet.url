...
public class TS_SURLHandler02ForPlainText extends TS_SURLHandler02ForPlainAbstract {
    ...
    private TS_SURLHandler02ForPlainText(HttpServlet hs, HttpServletRequest rq, HttpServletResponse rs, boolean noCache) {
    ...
    public static TS_SURLHandler02ForPlainText of(HttpServlet hs, HttpServletRequest rq, HttpServletResponse rs, boolean noCache) {
        return new TS_SURLHandler02ForPlainText(hs, rq, rs, noCache);
    }
}
